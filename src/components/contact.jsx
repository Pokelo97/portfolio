                        ...
                        <div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                            <div class="contact-block">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Email</h4>
                                        <p><a href="mailto:Lucky10bokalo@gmail.com">Lucky10bokalo@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="contact-block">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4>Phone</h4>
                                        <p><a href="tel:+27612449080">061 244 9080</a></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="contact-social">
                                <li style={{margin:"2px"}}>
                                    ...
                                    <a href="https://www.facebook.com/lucky.mohlala.399"><i class="bi bi-facebook"></i></a>
                                </li>
                                <li style={{margin:"2px"}}>
                                    <span class="contact-social-hex"></span>
                                    <a href="https://www.linkedin.com/in/mohlala-lucky-bb496a185"><i class="bi bi-linkedin"></i></a>
                                </li>
                                <li style={{margin:"2px"}}>
                                    <span class="contact-social-hex"></span>
                                    <a href="https://github.com/Pokelo97"><i class="bi bi-github"></i></a>
                                </li>
                            </ul>
                        </div>
